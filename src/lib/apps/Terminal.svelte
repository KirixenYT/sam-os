	...
	function neofetch() {
		...
		<div class="neofetch flex items-center gap-4">
			...
			<div class="text">
				...
				<b>created by:</b>
					<a class="text-white" href="https://github.com/kirixenyt" target="_blank">kirixen</a><br>
				<b>source code:</b>
					<a class="text-white" href="https://github.com/kirixenyt" target="_blank">Github</a><br>
				<b>courtesy:</b>
					<a class="text-white" href="https://kirisam.vercel.app" target="_blank">kirisam.vercel.app</a><br>
			</div>
		</div>
		`
	}
